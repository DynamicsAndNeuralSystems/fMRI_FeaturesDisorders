...
#   if (!file.exists(paste0(rdata_path, sprintf("Univariate_%s_Pairwise_%s_CV_linear_SVM_%s_%s_model_free_shuffle_pvals.Rds",
#                                               univariate_feature_set, pairwise_feature_set, weighting_name)))) {
...
#                                     grouping_var = "SPI")
#     
#     saveRDS(pvalues, file=paste0(rdata_path, sprintf("Univariate_%s_Pairwise_%s_CV_linear_SVM_%s_%s_model_free_shuffle_pvals.Rds",
#                                                      univariate_feature_set, pairwise_feature_set, weighting_name)))
#   }
# }
# 
