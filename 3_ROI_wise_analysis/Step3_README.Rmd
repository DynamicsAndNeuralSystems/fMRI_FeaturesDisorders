...
plot_main_vs_null_hist(main_res = region_wise_SVM_CV,
                       ...
                       title = "CV linear SVMResults vs. Model-Free Shuffles")
...
plot_top_5_vars_main_vs_null(class_res_pvals = region_wise_SVM_CV_plabs,
                             null_res = model_free_shuffle_null_res,
                             xlab = "Value",
...
```{r, fig.width=10, fig.height=5}
plot_top_5_vars_main_vs_null(class_res_pvals = region_wise_SVM_CV_inv_prob_plabs,
                             null_res = model_free_shuffle_null_res,
                             xlab = "Value",
                             ylab = "Scaled Density of Null Iterations",
...
```{r, fig.width=10, fig.height=5}
plot_top_5_vars_main_vs_null(class_res_pvals = region_wise_SVM_CV_SMOTE_plabs,
                             null_res = model_free_shuffle_null_res,
                             xlab = "Value",
                             ylab = "Scaled Density of Null Iterations",
...
```{r, fig.width=10, fig.height=5}
plot_top_5_vars_main_vs_null(class_res_pvals = region_wise_SVM_in_sample_plabs,
                             null_res = model_permutation_null_in_sample,
                             xlab = "Value",
                             ylab = "Scaled Density of Null Iterations",
...
```{r, fig.width=10, fig.height=5}
plot_top_5_vars_main_vs_null(class_res_pvals = region_wise_SVM_in_sample_inv_prob_plabs,
                             null_res = model_permutation_null_in_sample_inv_prob,
                             xlab = "Value",
                             ylab = "Scaled Density of Null Iterations",
