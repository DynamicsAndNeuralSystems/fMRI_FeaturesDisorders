...
if (!file.exists(paste0(rdata_path, "ROI_wise_linear_SVM_CV_catch22.Rds"))) {
  ...
  saveRDS(region_wise_SVM_CV, file=paste0(rdata_path, "ROI_wise_linear_SVM_CV_catch22.Rds"))
}
```
...
# Run in-sample SVM using given package + kernel
# If the RDS object doesn't already exist, otherwise load it in
if (!file.exists(paste0(rdata_path, "ROI_wise_linear_SVM_CV_catch22_inv_prob.Rds"))) {
  region_wise_SVM_CV_inv_prob <- run_cv_svm_by_input_var(rdata_path = rdata_path,
                                                         ...
                                                         use_SMOTE = FALSE,
                                                         noise_procs = noise_procs)
  saveRDS(region_wise_SVM_CV_inv_prob, file=paste0(rdata_path, "ROI_wise_linear_SVM_CV_catch22_inv_prob.Rds"))
}
```
...
# Run in-sample SVM using given package + kernel
# If the RDS object doesn't already exist, otherwise load it in
if (!file.exists(paste0(rdata_path, "ROI_wise_linear_SVM_CV_catch22_SMOTE.Rds"))) {
  region_wise_SVM_CV_SMOTE <- run_cv_svm_by_input_var(rdata_path = rdata_path,
                                                      ...
                                                      use_SMOTE = TRUE,
                                                      noise_procs = noise_procs)
  saveRDS(region_wise_SVM_CV_SMOTE, file=paste0(rdata_path, "ROI_wise_linear_SVM_CV_catch22_SMOTE.Rds"))
}
```
...
region_wise_SVM_CV <- readRDS(paste0(rdata_path, "ROI_wise_linear_SVM_CV_catch22.Rds"))
if (!file.exists(paste0(rdata_path, "ROI_wise_CV_linear_SVM_catch22_pvals.Rds"))) {
  region_wise_SVM_CV_pvals <- calc_empirical_nulls(class_res = region_wise_SVM_CV,
                                                   null_data = model_free_shuffle_null_res,
                                                   grouping_var = "Brain_Region")
  saveRDS(region_wise_SVM_CV_pvals, file=paste0(rdata_path, "ROI_wise_CV_linear_SVM_catch22_pvals.Rds"))
} else {
...
# Calculate p values from model-free shuffle null distribution
region_wise_SVM_CV_inv_prob <- readRDS(paste0(rdata_path, "ROI_wise_linear_SVM_CV_catch22_inv_prob.Rds"))
if (!file.exists(paste0(rdata_path, "ROI_wise_CV_linear_SVM_catch22_inv_prob_pvals.Rds"))) {
  region_wise_SVM_CV_inv_prob_pvals <- calc_empirical_nulls(class_res = region_wise_SVM_CV_inv_prob,
                                                   null_data = model_free_shuffle_null_res,
                                                   grouping_var = "Brain_Region")
  saveRDS(region_wise_SVM_CV_inv_prob_pvals, file=paste0(rdata_path, "ROI_wise_CV_linear_SVM_catch22_inv_prob_pvals.Rds"))
} else {
...
# Calculate p values from model-free shuffle null distribution
region_wise_SVM_CV_SMOTE <- readRDS(paste0(rdata_path, "ROI_wise_linear_SVM_CV_catch22_SMOTE.Rds"))
if (!file.exists(paste0(rdata_path, "ROI_wise_CV_linear_SVM_catch22_SMOTE_pvals.Rds"))) {
  region_wise_SVM_CV_SMOTE_pvals <- calc_empirical_nulls(class_res = region_wise_SVM_CV_SMOTE,
                                                   null_data = model_free_shuffle_null_res,
                                                   grouping_var = "Brain_Region")
  saveRDS(region_wise_SVM_CV_SMOTE_pvals, file=paste0(rdata_path, "ROI_wise_CV_linear_SVM_catch22_SMOTE_pvals.Rds"))
} else {
...
if (!file.exists(paste0(rdata_path, "ROI_wise_model_permutation_null_unweighted_catch22.Rds"))) {
  ...
  saveRDS(model_permutation_null_unweighted, file=paste0(rdata_path, "ROI_wise_model_permutation_null_unweighted_catch22.Rds"))
} else {
  model_permutation_null_unweighted <- readRDS(paste0(rdata_path, "ROI_wise_model_permutation_null_unweighted_catch22.Rds"))
}
...
```{r}
if (!file.exists(paste0(rdata_path, "ROI_wise_catch22_Unweighted_Null_Model_Fits_pvals.Rds"))) {
  region_wise_SVM_unweighted_pvals <- calc_empirical_nulls(class_res = region_wise_SVM_unweighted,
                                                          ...
                                                          grouping_var = "Brain_Region")
  saveRDS(region_wise_SVM_unweighted_pvals, file=paste0(rdata_path, "ROI_wise_catch22_Unweighted_Null_Model_Fits_pvals.Rds"))
} else {
...
if (!file.exists(paste0(rdata_path, "ROI_wise_model_permutation_null_inv_prob_catch22.Rds"))) {
  ...
  saveRDS(model_permutation_null_inv_prob, file=paste0(rdata_path, "ROI_wise_model_permutation_null_inv_prob_catch22.Rds"))
} else {
  model_permutation_null_inv_prob <- readRDS(paste0(rdata_path, "ROI_wise_model_permutation_null_inv_prob_catch22.Rds"))
}
# Find number of iterations for plot label
...
if (!file.exists(paste0(rdata_path, "ROI_wise_model_permutation_null_SMOTE_catch22.Rds"))) {
  ...
  saveRDS(model_permutation_null_SMOTE, file=paste0(rdata_path, "ROI_wise_model_permutation_null_SMOTE_catch22.Rds"))
} else {
...
if (!file.exists(paste0(rdata_path, "ROI_wise_SMOTE_Null_Model_Fits_pvals_catch22.Rds"))) {
  region_wise_SVM_SMOTE_pvals <- calc_empirical_nulls(class_res = region_wise_SVM_CV_SMOTE,
                                                              ...
                                                              grouping_var = "Brain_Region")
  saveRDS(region_wise_SVM_SMOTE_pvals, file=paste0(rdata_path, "ROI_wise_SMOTE_Null_Model_Fits_pvals_catch22.Rds"))
} else {
