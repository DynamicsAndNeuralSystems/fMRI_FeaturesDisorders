...
We can visualize PC1 vs. PC2 for an example ROI across the three different noise processing methods, like the left isthmus cingulate:
...
for (norm_method in norm_methods) {
  ...
  png(sprintf("plots/UCLA_%s_catch22_ROIwise_%s_%s.png",
              noise_label, test_method, norm_method), width=12, height=7, units="in", res=300)
  plot_class_stat_heatmap(classification_results = classification_results,
                          statistic = statistic,
                          noise_proc = noise_proc,
                          norm_method = norm_method,
