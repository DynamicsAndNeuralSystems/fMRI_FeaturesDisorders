...
combo_wise_SVM_in_sample <- readRDS(paste0(rdata_path, "multivar_combo_res_svmLinear_in_sample_e1071.Rds"))
...
# Plot accuracy + balanced accuracy in histograms
# Control subject proportion is highlighted for accuracy
combo_wise_SVM_in_sample_inv_prob <- readRDS(paste0(rdata_path, "multivar_combo_res_svmLinear_in_sample_e1071_inv_prob.Rds"))
...
# Run in-sample SVM using given package + kernel
# If the RDS object doesn't already exist, otherwise load it in
if (!file.exists(paste0(rdata_path, "multivar_combo_res_svmLinear_in_sample_", test_package, "_SMOTE.Rds"))) {
  combo_wise_SVM_in_sample_SMOTE <- run_in_sample_svm_by_input_var(rdata_path = rdata_path,
                                                                      ...
                                                                      use_inv_prob_weighting = FALSE,
                                                                      use_SMOTE = TRUE) 
  saveRDS(combo_wise_SVM_in_sample_SMOTE, file=paste0(rdata_path, "multivar_combo_res_svmLinear_in_sample_", test_package, "_SMOTE.Rds"))
} 
```
...
# Plot accuracy + balanced accuracy in histograms
# Control subject proportion is highlighted for accuracy
combo_wise_SVM_in_sample_SMOTE <- readRDS(paste0(rdata_path, "multivar_combo_res_svmLinear_in_sample_e1071_SMOTE.Rds"))
...
```{r, eval=F, echo=F}
# Save plot
ggsave("plots/In_Sample_combo_wise_linear_SVM_Multivar_e1071_SMOTE.png",
       width=7, height=5, units="in", dpi=300)
```
...
# Control subject proportion is highlighted for accuracy
noise_procs = c("AROMA+2P", "AROMA+2P+GMR", "AROMA+2P+DiCER")
combo_wise_SVM_CV <- readRDS(paste0(rdata_path, "combo_wise_multi_ROI_svmLinear_CV_e1071.Rds"))
...
```{r, fig.width=7, fig.height=5}
noise_procs = c("AROMA+2P", "AROMA+2P+GMR", "AROMA+2P+DiCER")
combo_wise_SVM_CV_inv_prob <- readRDS(paste0(rdata_path, "combo_wise_multi_ROI_svmLinear_CV_e1071_inv_prob.Rds"))
...
# Run theft's multivariable classifier on each ROI and save to an RDS object
# If the RDS object doesn't already exist, otherwise load it in
if (!file.exists(paste0(rdata_path, "combo_wise_multi_ROI_svmLinear_CV_", test_package, "_SMOTE.Rds"))) {
  ...
  saveRDS(combo_wise_SVM_CV_SMOTE, file=paste0(rdata_path, "combo_wise_multi_ROI_svmLinear_CV_", test_package, "_SMOTE.Rds"))
} 
```

```{r, fig.width=7, fig.height=5}
noise_procs = c("AROMA+2P", "AROMA+2P+GMR", "AROMA+2P+DiCER")
combo_wise_SVM_CV_SMOTE <- readRDS(paste0(rdata_path, "combo_wise_multi_ROI_svmLinear_CV_e1071_SMOTE.Rds"))
...
if (!file.exists(paste0(rdata_path, "Combo_wise_10FCV_linear_SVM_e1071_pvals.Rds"))) {
  e1071_combo_wise_SVM_CV_pvals <- calc_empirical_nulls(class_res = e1071_combo_wise_SVM_CV,
                                                        ...
                                                        grouping_var = "All")
  saveRDS(e1071_combo_wise_SVM_CV_pvals, file=paste0(rdata_path, "Combo_wise_10FCV_linear_SVM_e1071_pvals.Rds"))
  
} else {
  e1071_combo_wise_SVM_CV_pvals <- readRDS(paste0(rdata_path, "Combo_wise_10FCV_linear_SVM_e1071_pvals.Rds"))
}
...
if (!file.exists(paste0(rdata_path, "Combo_wise_10FCV_linear_SVM_e1071_inv_prob_pvals.Rds"))) {
  e1071_combo_wise_SVM_CV_inv_prob_pvals <- calc_empirical_nulls(class_res = e1071_combo_wise_SVM_CV_inv_prob,
                                                        null_data = model_free_shuffle_null_res,
                                                        grouping_var = "All")
  saveRDS(e1071_combo_wise_SVM_CV_inv_prob_pvals, file=paste0(rdata_path, "Combo_wise_10FCV_linear_SVM_e1071_inv_prob_pvals.Rds"))
  
} else {
  e1071_combo_wise_SVM_CV_inv_prob_pvals <- readRDS(paste0(rdata_path, "Combo_wise_10FCV_linear_SVM_e1071_inv_prob_pvals.Rds"))
}

e1071_combo_wise_SVM_CV_inv_prob_plabs <- e1071_combo_wise_SVM_CV_inv_prob_pvals %>%
  mutate(acc_p = scales::scientific(acc_p, digits = 3),
         bal_acc_p = scales::scientific(bal_acc_p, digits = 3),
         acc_p_adj = scales::scientific(acc_p_adj, digits = 3),
         bal_acc_p_adj = scales::scientific(bal_acc_p_adj, digits = 3))
...
Accuracy:
```{r, fig.width=7, fig.height=5}
e1071_combo_wise_SVM_CV_inv_prob_pvals %>%
  ggplot(data=.) +
  geom_histogram(data = subset(model_free_shuffle_null_res, Type=="null"),
                 aes(x = accuracy, y=0.5*..density..), 
                 bins = 50,
...
```{r, eval=F, echo=F}
# Save plot
ggsave("plots/Main_vs_Null_Acc_10FCV_Linear_SVM_inv_prob_combo_wise.png",
       width=8, height=5, units="in", dpi=300)
```
...
```{r, eval=F, echo=F}
# Save plot
ggsave("plots/Main_vs_Null_BAcc_10FCV_Linear_SVM_inv_prob_combo_wise.png",
       width=8, height=5, units="in", dpi=300)
```
...
real_1804_acc <- e1071_combo_wise_SVM_CV_inv_prob %>%
  filter(Noise_Proc=="AROMA+2P") %>%
  summarise(mean_accuracy = mean(accuracy, na.rm=T),
            mean_balanced_accuracy = mean(balanced_accuracy, na.rm=T)) %>%
  mutate(Type="main")
