...
plot_main_vs_null_hist(main_res = feature_wise_SVM_in_sample,
                       ...
                       xlab = "Value from n=8,200 Null Model Fit Shuffles",
                       title = "In-sample linear SVM Results vs. Null Model Fits")
...
plot_main_vs_null_hist(main_res = feature_wise_SVM_in_sample_inv_prob,
                       ...
                       xlab = "Value from n=8,200 Null Model Fit Shuffles",
                       title = "In-sample Inv Prob linear SVM Results vs. Null Model Fits")
...
plot_top_5_vars_main_vs_null(class_res_pvals = feature_wise_SVM_in_sample_inv_prob_pvals,
                             ...
                             xlab = "Value",
                             ylab = "Scaled Density of Null Iterations",
                             title = "Main and Null Model Fit Balanced Accuracy\nfor top AROMA+2P catch22 Features, In-Sample Inv Prob")
...
plot_main_vs_null_hist(main_res = feature_wise_SVM_CV_inv_prob,
                       ...
                       xlab = "Value from n=8,200 Null Model Fit Shuffles",
                       title = "CV Inv Prob linear SVM Results vs. Null Model Fits")
...
plot_main_vs_null_hist(main_res = feature_wise_SVM_CV_SMOTE,
                       ...
                       xlab = "Value from n=8,200 Null Model Fit Shuffles",
                       title = "CV SMOTE linear SVM Results vs. Null Model Fits")
