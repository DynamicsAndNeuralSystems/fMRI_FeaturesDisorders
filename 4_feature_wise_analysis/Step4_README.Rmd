...
# Save plot
ggsave("plots/Feature_Wise_linear_SVM_in_sample.png",
...
# Save plot
ggsave("plots/Feature_Wise_linear_SVM_in_sample_inv_prob.png",
       width=7,height=5, units="in", dpi=300)
```
...
# Save plot
ggsave("plots/Feature_Wise_linear_SVM_in_sample_SMOTE.png",
       width=7,height=5, units="in", dpi=300)
```
...
plot_main_vs_null_hist(main_res = feature_wise_SVM_CV,
                       ...
                       title = "CV linear SVM Results vs.\nModel-Free Shuffles")

# Save plot
ggsave("plots/Feature_Wise_CV_Null_Model_Free_Shuffle_vs_Real.png",
       width=7, height=5, units="in", dpi=300)
```
...
plot_top_5_vars_main_vs_null(class_res_pvals = feature_wise_SVM_CV_pvals,
                             null_res = model_free_shuffle_null_res,
                             xlab = "Value",
                             ylab = "Scaled Density of Null Iterations",
                             title = "Main CV and Model-Free Shuffle Null Balanced Accuracy\nfor top AROMA+2P catch22 Features",
                             yloc = 8,
                             xloc = 0.6)
...
```{r, fig.width=10, fig.height=5}
plot_top_5_vars_main_vs_null(class_res_pvals = feature_wise_SVM_CV_inv_prob_pvals,
                             null_res = model_free_shuffle_null_res,
                             xlab = "Value",
                             ylab = "Scaled Density of Null Iterations",
...
```{r, fig.width=10, fig.height=5}
plot_top_5_vars_main_vs_null(class_res_pvals = feature_wise_SVM_CV_SMOTE_pvals,
                             null_res = model_free_shuffle_null_res,
                             xlab = "Value",
                             ylab = "Scaled Density of Null Iterations",
...
if (!file.exists(paste0(rdata_path, "Feature_wise_model_permutation_null_in_sample.Rds"))) {
  ...
  saveRDS(model_permutation_null_in_sample, file=paste0(rdata_path, "Feature_wise_model_permutation_null_in_sample.Rds"))
} else {
  model_permutation_null_in_sample <- readRDS(paste0(rdata_path, "Feature_wise_model_permutation_null_in_sample.Rds"))
}
...
plot_main_vs_null_hist(main_res = feature_wise_SVM_in_sample,
...
# Save plot
ggsave("plots/Feature_Wise_Null_Model_Fit_In_Sample_Balanced_Accuracy.png",
       width=7, height=5, units="in", dpi=300)
```
...
if (!file.exists(paste0(rdata_path, "Feature_wise_In_Sample_Null_Model_Fits_pvals.Rds"))) {
  feature_wise_SVM_in_sample_pvals <- calc_empirical_nulls(class_res = feature_wise_SVM_in_sample,
                                                           null_data = model_permutation_null_in_sample,
                                                           grouping_var = "Feature")
  saveRDS(feature_wise_SVM_in_sample_pvals, file=paste0(rdata_path, "Feature_wise_In_Sample_Null_Model_Fits_pvals.Rds"))
} else {
  feature_wise_SVM_in_sample_pvals <- readRDS(paste0(rdata_path, "Feature_wise_In_Sample_Null_Model_Fits_pvals.Rds"))
}

feature_wise_SVM_in_sample_plabs <- truncate_p_values(feature_wise_SVM_in_sample_pvals)
```

```{r, fig.width=10, fig.height=5}
plot_top_5_vars_main_vs_null(class_res_pvals = feature_wise_SVM_in_sample_pvals,
                             null_res = model_permutation_null_in_sample,
                             xlab = "Value",
                             ylab = "Scaled Density of Null Iterations",
                             title = "Main In-Sample and Null Model Fit Balanced Accuracy\nfor top AROMA+2P catch22 features, In-Sample",
                             xloc = 0.94, 
                             yloc = 6.5)
...
```{r}
summarise_num_sig_features(feature_wise_SVM_in_sample_pvals)
```
...
if (!file.exists(paste0(rdata_path, "Feature_wise_model_permutation_null_in_sample_inv_prob.Rds"))) {
  ...
  saveRDS(model_permutation_null_in_sample_inv_prob, file=paste0(rdata_path, "Feature_wise_model_permutation_null_in_sample_inv_prob.Rds"))
} else {
  model_permutation_null_in_sample_inv_prob <- readRDS(paste0(rdata_path, "Feature_wise_model_permutation_null_in_sample_inv_prob.Rds"))
}
# Find number of iterations for plot label
...
plot_main_vs_null_hist(main_res = feature_wise_SVM_in_sample_inv_prob,
                       null_res = model_permutation_null_in_sample_inv_prob,
                       xlab = sprintf("Value from n=%s Null Model Fit Shuffles", num_null_dist_values),
                       title = "In-sample Inv Prob linear SVM Results vs.\nNull Model Fits")

ggsave("plots/feature_wise_Null_Model_Fit_In_Sample_Balanced_Accuracy_Inv_Prob.png",
       width=7, height=5, units="in", dpi=300)
```
...
if (!file.exists(paste0(rdata_path, "Feature_wise_In_Sample_Null_Model_Fits_pvals_inv_prob.Rds"))) {
  feature_wise_SVM_in_sample_inv_prob_pvals <- calc_empirical_nulls(class_res = feature_wise_SVM_in_sample_inv_prob,
                                                              null_data = model_permutation_null_in_sample_inv_prob,
                                                              grouping_var = "Feature")
  saveRDS(feature_wise_SVM_in_sample_inv_prob_pvals, file=paste0(rdata_path, "Feature_wise_In_Sample_Null_Model_Fits_pvals_inv_prob.Rds"))
} else {
  feature_wise_SVM_in_sample_inv_prob_pvals <- readRDS(paste0(rdata_path, "Feature_wise_In_Sample_Null_Model_Fits_pvals_inv_prob.Rds"))
}

feature_wise_SVM_in_sample_inv_prob_plabs <- truncate_p_values(feature_wise_SVM_in_sample_inv_prob_pvals)
```

```{r, fig.width=10, fig.height=5}
plot_top_5_vars_main_vs_null(class_res_pvals = feature_wise_SVM_in_sample_inv_prob_pvals,
                             null_res = model_permutation_null_in_sample_inv_prob,
                             xlab = "Value",
                             ylab = "Scaled Density of Null Iterations",
...
```{r}
summarise_num_sig_features(feature_wise_SVM_in_sample_inv_prob_pvals)
```
...
if (!file.exists(paste0(rdata_path, "Feature_wise_model_permutation_null_CV_inv_prob.Rds"))) {
  ...
  saveRDS(model_permutation_null_CV_inv_prob, file=paste0(rdata_path, "Feature_wise_model_permutation_null_CV_inv_prob.Rds"))
} else {
  model_permutation_null_CV_inv_prob <- readRDS(paste0(rdata_path, "Feature_wise_model_permutation_null_CV_inv_prob.Rds"))
}
# Find number of iterations for plot label
num_null_dist_values <- nrow(model_permutation_null_in_sample %>% filter(Noise_Proc == "AROMA+2P"))
```
...
# Save plot
ggsave("plots/feature_wise_Null_Model_Fit_CV_Balanced_Accuracy_Inv_Prob.png",
       width=7, height=5, units="in", dpi=300)
```
...
if (!file.exists(paste0(rdata_path, "Feature_wise_CV_Null_Model_Fits_pvals_inv_prob.Rds"))) {
  feature_wise_SVM_CV_inv_prob_pvals <- calc_empirical_nulls(class_res = feature_wise_SVM_CV_inv_prob,
                                                              null_data = model_permutation_null_CV_inv_prob,
                                                              grouping_var = "Feature")
  saveRDS(feature_wise_SVM_CV_inv_prob_pvals, file=paste0(rdata_path, "Feature_wise_CV_Null_Model_Fits_pvals_inv_prob.Rds"))
} else {
  feature_wise_SVM_CV_inv_prob_pvals <- readRDS(paste0(rdata_path, "Feature_wise_CV_Null_Model_Fits_pvals_inv_prob.Rds"))
}
...
plot_top_5_vars_main_vs_null(class_res_pvals = feature_wise_SVM_CV_inv_prob_pvals,
                             ...
                             xlab = "Value",
                             ylab = "Scaled Density of Null Iterations",
                             title = "Main and Null Model Fit Balanced Accuracy\nfor top AROMA+2P catch22 Features, CV Inv Prob",
                             xloc = 0.58,
                             yloc = 4.5)

# Save plot
ggsave("plots/feature_wise_Null_Model_Fit_CV_Inv_Prob_Balanced_Accuracy.png", width=10, 
       height=5, units="in", dpi=300)
```
...
if (!file.exists(paste0(rdata_path, "Feature_wise_model_permutation_null_CV_SMOTE.Rds"))) {
  ...
  saveRDS(model_permutation_null_CV_SMOTE, file=paste0(rdata_path, "Feature_wise_model_permutation_null_CV_SMOTE.Rds"))
} else {
  model_permutation_null_CV_SMOTE <- readRDS(paste0(rdata_path, "Feature_wise_model_permutation_null_CV_SMOTE.Rds"))
}
# Find number of iterations for plot label
num_null_dist_values <- nrow(model_permutation_null_in_sample %>% filter(Noise_Proc == "AROMA+2P"))
```
...
# Save plot
ggsave("plots/feature_wise_Null_Model_Fit_CV_Balanced_Accuracy_SMOTE.png",
       width=7, height=5, units="in", dpi=300)
```
...
if (!file.exists(paste0(rdata_path, "Feature_wise_CV_Null_Model_Fits_pvals_SMOTE.Rds"))) {
  feature_wise_SVM_CV_SMOTE_pvals <- calc_empirical_nulls(class_res = feature_wise_SVM_CV_SMOTE,
                                                              null_data = model_permutation_null_CV_SMOTE,
                                                              grouping_var = "Feature")
  saveRDS(feature_wise_SVM_CV_SMOTE_pvals, file=paste0(rdata_path, "Feature_wise_CV_Null_Model_Fits_pvals_SMOTE.Rds"))
} else {
  feature_wise_SVM_CV_SMOTE_pvals <- readRDS(paste0(rdata_path, "Feature_wise_CV_Null_Model_Fits_pvals_SMOTE.Rds"))
}
...
# Save plot
ggsave("plots/feature_wise_Null_Model_Fit_Top5_Regions_CV_SMOTE_Balanced_Accuracy.png", width=10, 
       height=5, units="in", dpi=300)
```
