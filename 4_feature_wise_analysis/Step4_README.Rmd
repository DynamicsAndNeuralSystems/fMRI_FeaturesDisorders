...
e1071_feature_wise_SVM_in_sample <- readRDS(paste0(rdata_path, "multivar_feature_res_svmLinear_in_sample_e1071.Rds"))

noise_procs = c("AROMA+2P", "AROMA+2P+GMR", "AROMA+2P+DiCER")
plot_class_acc_w_props(class_res = e1071_feature_wise_SVM_in_sample,
                       group_var = "Feature",
                       cv = FALSE,
...
# Plot accuracy + balanced accuracy in histograms
# Control subject proportion is highlighted for accuracy
kernlab_feature_wise_SVM_in_sample <- readRDS(paste0(rdata_path, "multivar_feature_res_svmLinear_in_sample_kernlab.Rds"))

noise_procs = c("AROMA+2P", "AROMA+2P+GMR", "AROMA+2P+DiCER")
plot_class_acc_w_props(class_res = kernlab_feature_wise_SVM_in_sample,
                       group_var = "Feature",
                       cv = FALSE,
                       rdata_path = rdata_path,
                       noise_procs = noise_procs)
...
```{r, eval=F, echo=F}
# Save plot
ggsave("plots/In_Sample_Feature_Wise_linear_SVM_Multivar_kernlab.png",
       width=7, height=6, units="in", dpi=300)
```
...
# Plot accuracy + balanced accuracy in histograms
# Control subject proportion is highlighted for accuracy
e1071_feature_wise_SVM_in_sample_inv_prob <- readRDS(paste0(rdata_path, "multivar_feature_res_svmLinear_in_sample_e1071_inv_prob.Rds"))

noise_procs = c("AROMA+2P", "AROMA+2P+GMR", "AROMA+2P+DiCER")
plot_class_acc_w_props(class_res = e1071_feature_wise_SVM_in_sample_inv_prob,
                       group_var = "Feature",
                       cv = FALSE,
                       rdata_path = rdata_path,
                       noise_procs = noise_procs)
...
# Plot accuracy + balanced accuracy in histograms
# Control subject proportion is highlighted for accuracy
kernlab_feature_wise_SVM_in_sample_inv_prob <- readRDS(paste0(rdata_path, "multivar_feature_res_svmLinear_in_sample_kernlab_inv_prob.Rds"))

noise_procs = c("AROMA+2P", "AROMA+2P+GMR", "AROMA+2P+DiCER")
plot_class_acc_w_props(class_res = kernlab_feature_wise_SVM_in_sample_inv_prob,
                       group_var = "Feature",
                       cv = FALSE,
                       rdata_path = rdata_path,
                       noise_procs = noise_procs)
...
```{r, eval=F, echo=F}
# Save plot
ggsave("plots/In_Sample_Feature_Wise_linear_SVM_Multivar_kernlab_inv_prob.png",
       width=7, height=6, units="in", dpi=300)
```
...
for (i in 1:nrow(svm_df)) {
  ...
  # Run in-sample SVM using given package + kernel
  # If the RDS object doesn't already exist, otherwise load it in
  if (!file.exists(paste0(rdata_path, "feature_wise_multi_ROI_svmLinear_CV_", test_package, ".Rds"))) {
    feature_wise_SVM_CV <- run_cv_svm_by_input_var(rdata_path = rdata_path,
      ...
      dplyr::rename("accuracy" = "Accuracy",
                    "balanced_accuracy" = "Balanced_Accuracy")
    saveRDS(feature_wise_SVM_CV, file=paste0(rdata_path, "feature_wise_multi_ROI_svmLinear_CV_", test_package, ".Rds"))
  }
}
```
...
# Plot accuracy + balanced accuracy in histograms
# Control subject proportion is highlighted for accuracy
e1071_feature_wise_SVM_CV <- readRDS(paste0(rdata_path, "feature_wise_multi_ROI_svmLinear_CV_e1071.Rds"))

noise_procs = c("AROMA+2P", "AROMA+2P+GMR", "AROMA+2P+DiCER")
plot_class_acc_w_props(class_res = e1071_feature_wise_SVM_CV,
                       cv = TRUE,
                       group_var = "Feature",
                       rdata_path = rdata_path,
                       noise_procs = noise_procs)
...
# Plot accuracy + balanced accuracy in histograms
# Control subject proportion is highlighted for accuracy
kernlab_feature_wise_SVM_CV <- readRDS(paste0(rdata_path, "feature_wise_multi_ROI_svmLinear_CV_kernlab.Rds"))

noise_procs = c("AROMA+2P", "AROMA+2P+GMR", "AROMA+2P+DiCER")
plot_class_acc_w_props(class_res = kernlab_feature_wise_SVM_CV,
                       group_var = "Feature",
                       cv = TRUE,
                       rdata_path = rdata_path,
                       noise_procs = noise_procs)
...
```{r, eval=F, echo=F}
# Save plot
ggsave("plots/Feature_Wise_linear_SVM_CV_Multivar_kernlab.png",
       width=7, height=6, units="in", dpi=300)
```
...
for (i in 1:nrow(svm_df)) {
  ...
  # Run in-sample SVM using given package + kernel
  # If the RDS object doesn't already exist, otherwise load it in
  if (!file.exists(paste0(rdata_path, "feature_wise_multi_ROI_svmLinear_CV_", test_package, "_inv_prob.Rds"))) {
    feature_wise_SVM_in_sample_inv_prob <- run_cv_svm_by_input_var(rdata_path = rdata_path,
      ...
      dplyr::rename("accuracy" = "Accuracy",
                    "balanced_accuracy" = "Balanced_Accuracy")
    saveRDS(feature_wise_SVM_in_sample_inv_prob, file=paste0(rdata_path, "feature_wise_multi_ROI_svmLinear_CV_", test_package, "_inv_prob.Rds"))
  }
}
```
...
# Plot accuracy + balanced accuracy in histograms
# Control subject proportion is highlighted for accuracy
e1071_feature_wise_SVM_CV_inv_prob <- readRDS(paste0(rdata_path, "feature_wise_multi_ROI_svmLinear_CV_e1071_inv_prob.Rds"))

noise_procs = c("AROMA+2P", "AROMA+2P+GMR", "AROMA+2P+DiCER")
plot_class_acc_w_props(class_res = e1071_feature_wise_SVM_CV_inv_prob,
                       group_var = "Feature",
                       cv = TRUE,
                       rdata_path = rdata_path,
                       noise_procs = noise_procs)
...
# Plot accuracy + balanced accuracy in histograms
# Control subject proportion is highlighted for accuracy
kernlab_feature_wise_SVM_CV_inv_prob <- readRDS(paste0(rdata_path, "feature_wise_multi_ROI_svmLinear_CV_kernlab_inv_prob.Rds"))

noise_procs = c("AROMA+2P", "AROMA+2P+GMR", "AROMA+2P+DiCER")
plot_class_acc_w_props(class_res = kernlab_feature_wise_SVM_CV_inv_prob,
                       group_var = "Feature",
                       cv = TRUE,
                       rdata_path = rdata_path,
                       noise_procs = noise_procs)
...
```{r, eval=F, echo=F}
# Save plot
ggsave("plots/Feature_Wise_linear_SVM_CV_Multivar_kernlab_inv_prob.png",
       width=7, height=6, units="in", dpi=300)
```
...
if (!file.exists(paste0(rdata_path, "Feature_wise_10FCV_linear_SVM_e1071_pvals.Rds"))) {
  e1071_feature_wise_SVM_CV_pvals <- calc_empirical_nulls(class_res = e1071_feature_wise_SVM_CV,
                                                                   ...
                                                                   grouping_var = "Feature")
  saveRDS(e1071_feature_wise_SVM_CV_pvals, file=paste0(rdata_path, "Feature_wise_10FCV_linear_SVM_e1071_pvals.Rds"))
  
} else {
  e1071_feature_wise_SVM_CV_pvals <- readRDS(paste0(rdata_path, "Feature_wise_10FCV_linear_SVM_e1071_pvals.Rds"))
}
...
if (!file.exists(paste0(rdata_path, "Feature_wise_10FCV_linear_SVM_e1071_inv_prob_pvals.Rds"))) {
  e1071_feature_wise_SVM_CV_inv_prob_pvals <- calc_empirical_nulls(class_res = e1071_feature_wise_SVM_CV_inv_prob,
                                                                   null_data = model_free_shuffle_null_res,
                                                                   grouping_var = "Feature")
  saveRDS(e1071_feature_wise_SVM_CV_inv_prob_pvals, file=paste0(rdata_path, "Feature_wise_10FCV_linear_SVM_e1071_inv_prob_pvals.Rds"))
  
} else {
  e1071_feature_wise_SVM_CV_inv_prob_pvals <- readRDS(paste0(rdata_path, "Feature_wise_10FCV_linear_SVM_e1071_inv_prob_pvals.Rds"))
}
