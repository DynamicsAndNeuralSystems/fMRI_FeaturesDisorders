---
title: "Step 3: ROI-Wise catchaMouse16 Feature Analysis"
output: 
  github_document
...
if (!file.exists(paste0(rdata_path, "ROI_wise_linear_SVM_CV_catchaMouse16.Rds"))) {
  ...
  saveRDS(region_wise_SVM_CV, file=paste0(rdata_path, "ROI_wise_linear_SVM_CV_catchaMouse16.Rds"))
}
```
...
region_wise_SVM_CV <- readRDS(paste0(rdata_path, "ROI_wise_linear_SVM_CV_catchaMouse16.Rds"))
...
plot_class_acc_w_props(class_res = region_wise_SVM_CV,
                       ...
                       noise_procs = noise_procs,
                       plot_title = "Unweighted ROI-wise catchaMouse16 Linear SVM Results")

# Save plot
ggsave("plots/Region_Wise_catchaMouse16_CV_SVM.png",
...
# Run in-sample SVM using given package + kernel
# If the RDS object doesn't already exist, otherwise load it in
if (!file.exists(paste0(rdata_path, "ROI_wise_linear_SVM_CV_catchaMouse16_inv_prob.Rds"))) {
  region_wise_SVM_CV_inv_prob <- run_cv_svm_by_input_var(rdata_path = rdata_path,
                                                         ...
                                                         use_SMOTE = FALSE,
                                                         noise_procs = noise_procs)
  saveRDS(region_wise_SVM_CV_inv_prob, file=paste0(rdata_path, "ROI_wise_linear_SVM_CV_catchaMouse16_inv_prob.Rds"))
}
```
...
# Plot accuracy + balanced accuracy in histograms
# Control subject proportion is highlighted for accuracy
region_wise_SVM_CV_inv_prob <- readRDS(paste0(rdata_path, "ROI_wise_linear_SVM_CV_catchaMouse16_inv_prob.Rds"))
...
# Save plot
ggsave("plots/Region_Wise_CV_SVM_Inv_Prob_catchaMouse16.png",
       width=8, height=4.5, units="in", dpi=300)
```
...
# Run in-sample SVM using given package + kernel
# If the RDS object doesn't already exist, otherwise load it in
if (!file.exists(paste0(rdata_path, "ROI_wise_linear_SVM_CV_catchaMouse16_SMOTE.Rds"))) {
  region_wise_SVM_CV_SMOTE <- run_cv_svm_by_input_var(rdata_path = rdata_path,
                                                      ...
                                                      use_SMOTE = TRUE,
                                                      noise_procs = noise_procs)
  saveRDS(region_wise_SVM_CV_SMOTE, file=paste0(rdata_path, "ROI_wise_linear_SVM_CV_catchaMouse16_SMOTE.Rds"))
}
```
...
# Plot accuracy + balanced accuracy in histograms
# Control subject proportion is highlighted for accuracy
region_wise_SVM_CV_SMOTE <- readRDS(paste0(rdata_path, "ROI_wise_linear_SVM_CV_catchaMouse16_SMOTE.Rds"))
...
plot_class_acc_w_props(class_res = region_wise_SVM_CV_SMOTE,
                       ...
                       rdata_path = rdata_path,
                       noise_procs = noise_procs,
                       plot_title = "SMOTE-Weighted catchaMouse16 ROI-wise Linear SVM Results")

# Save plot
ggsave("plots/Region_Wise_CV_SVM_SMOTE_catchaMouse16.png",
       width=8, height=4.5, units="in", dpi=300)
```
...
if (!file.exists(paste0(rdata_path, "Null_Model_Free_Shuffles_catchaMouse16.Rds"))) {
  model_free_shuffle_null_res <- run_model_free_n_shuffles(num_shuffles = 100000,
                                                           feature_set = "catchaMouse16",
                                                           rdata_path = rdata_path)
  saveRDS(model_free_shuffle_null_res, file = paste0(rdata_path, "Null_Model_Free_Shuffles_catchaMouse16.Rds"))
} else {
  model_free_shuffle_null_res <- readRDS(paste0(rdata_path, "Null_Model_Free_Shuffles_catchaMouse16.Rds"))
}
```
...
plot_main_vs_null_hist(main_res = region_wise_SVM_CV,
                       ...
                       title = "Unweighted Region-Wise Linear SVM catchaMouse16\nvs. Model-Free Shuffles")

# Save plot
ggsave("plots/Region_Wise_Unweighted_catchaMouse16_Null_vs_Real_Model_Free_Shuffle.png",
       width=8, height=4.5, units="in", dpi=300)
```
...
region_wise_SVM_CV <- readRDS(paste0(rdata_path, "ROI_wise_linear_SVM_CV_catchaMouse16.Rds"))
if (!file.exists(paste0(rdata_path, "ROI_wise_CV_linear_SVM_catchaMouse16_pvals.Rds"))) {
  region_wise_SVM_CV_pvals <- calc_empirical_nulls(class_res = region_wise_SVM_CV,
                                                   null_data = model_free_shuffle_null_res,
                                                   grouping_var = "Brain_Region")
  saveRDS(region_wise_SVM_CV_pvals, file=paste0(rdata_path, "ROI_wise_CV_linear_SVM_catchaMouse16_pvals.Rds"))
} else {
  region_wise_SVM_CV_pvals <- readRDS(paste0(rdata_path, "ROI_wise_CV_linear_SVM_catchaMouse16_pvals.Rds"))
}
...
plot_top_6_vars_main_vs_null(class_res_pvals = region_wise_SVM_CV_pvals,
                             ...
                             title = "Main Out-of-Sample and Model-Free Shuffle Null\ncatchaMouse16 Balanced Accuracy for top AROMA+2P Brain Regions",
                             yloc = 9.5)

ggsave("plots/Region_Wise_catchaMouse16_Model_Free_Shuffle_Top_Regions_Out_of_Sample_SVM_Balanced_Accuracy.png", width=10, 
...
plot_main_vs_null_hist(main_res = region_wise_SVM_CV_inv_prob,
                       null_res = model_free_shuffle_null_res,
                       xlab = "Value from n=100,000 Model-Free Shuffles",
                       title = "Inv Prob Region-Wise Linear SVM catchaMouse16\nvs. Model-Free Shuffles")

# Save plot
ggsave("plots/Region_Wise_Inv_Prob_catchaMouse16_Null_vs_Real_Model_Free_Shuffle.png",
       width=8, height=4.5, units="in", dpi=300)
```
...
# Calculate p values from model-free shuffle null distribution
region_wise_SVM_CV_inv_prob <- readRDS(paste0(rdata_path, "ROI_wise_linear_SVM_CV_catchaMouse16_inv_prob.Rds"))
if (!file.exists(paste0(rdata_path, "ROI_wise_CV_linear_SVM_catchaMouse16_inv_prob_pvals.Rds"))) {
  region_wise_SVM_CV_inv_prob_pvals <- calc_empirical_nulls(class_res = region_wise_SVM_CV_inv_prob,
                                                   null_data = model_free_shuffle_null_res,
                                                   grouping_var = "Brain_Region")
  saveRDS(region_wise_SVM_CV_inv_prob_pvals, file=paste0(rdata_path, "ROI_wise_CV_linear_SVM_catchaMouse16_inv_prob_pvals.Rds"))
} else {
  region_wise_SVM_CV_inv_prob_pvals <- readRDS(paste0(rdata_path, "ROI_wise_CV_linear_SVM_catchaMouse16_inv_prob_pvals.Rds"))
}
...
plot_top_6_vars_main_vs_null(class_res_pvals = region_wise_SVM_CV_inv_prob_pvals,
                             ...
                             xlab = "Value",
                             ylab = "Scaled Density of Null Iterations",
                             title = "Main Out-of-Sample catchaMouse16 and Model-Free Shuffle Null Balanced Accuracy\nfor top AROMA+2P Brain Regions, Inverse Probability",
                             yloc = 9.5)

# Save plot
ggsave("plots/Region_Wise_catchaMouse16_Inv_Prob_Model_Free_Shuffle_Top_Regions_Out_of_Sample_SVM_Balanced_Accuracy.png", width=10, 
       height=5, units="in", dpi=300)
```
...
plot_main_vs_null_hist(main_res = region_wise_SVM_CV_SMOTE,
                       null_res = model_free_shuffle_null_res,
                       xlab = "Value from n=100,000 Model-Free Shuffles",
                       title = "SMOTE Region-Wise Linear SVM catchaMouse16\nvs. Model-Free Shuffles")

# Save plot
ggsave("plots/Region_Wise_SMOTE_catchaMouse16_Null_vs_Real_Model_Free_Shuffle.png",
       width=8, height=4.5, units="in", dpi=300)
```
...
# Calculate p values from model-free shuffle null distribution
region_wise_SVM_CV_SMOTE <- readRDS(paste0(rdata_path, "ROI_wise_linear_SVM_CV_catchaMouse16_SMOTE.Rds"))
if (!file.exists(paste0(rdata_path, "ROI_wise_CV_linear_SVM_catchaMouse16_SMOTE_pvals.Rds"))) {
  region_wise_SVM_CV_SMOTE_pvals <- calc_empirical_nulls(class_res = region_wise_SVM_CV_SMOTE,
                                                   null_data = model_free_shuffle_null_res,
                                                   grouping_var = "Brain_Region")
  saveRDS(region_wise_SVM_CV_SMOTE_pvals, file=paste0(rdata_path, "ROI_wise_CV_linear_SVM_catchaMouse16_SMOTE_pvals.Rds"))
} else {
  region_wise_SVM_CV_SMOTE_pvals <- readRDS(paste0(rdata_path, "ROI_wise_CV_linear_SVM_catchaMouse16_SMOTE_pvals.Rds"))
}
...
# Save plot
ggsave("plots/Region_Wise_catchaMouse16_SMOTE_Model_Free_Shuffle_Top_Regions_Out_of_Sample_SVM_Balanced_Accuracy.png", width=10, 
       height=5, units="in", dpi=300)
```
...
if (!file.exists(paste0(rdata_path, "ROI_wise_model_permutation_null_unweighted_catchaMouse16.Rds"))) {
  ...
  saveRDS(model_permutation_null_unweighted, file=paste0(rdata_path, "ROI_wise_model_permutation_null_unweighted_catchaMouse16.Rds"))
} else {
  model_permutation_null_unweighted <- readRDS(paste0(rdata_path, "ROI_wise_model_permutation_null_unweighted_catchaMouse16.Rds"))
}
...
region_wise_SVM_unweighted <- readRDS(paste0(rdata_path, "ROI_wise_linear_SVM_CV_catchaMouse16.Rds"))
...
plot_main_vs_null_hist(main_res = region_wise_SVM_unweighted,
                       ...
                       title = "Region-wise Unweighted catchaMouse16 Linear SVM Results\nvs. Null Model Fits")

# Save plot
ggsave("plots/Region_Wise_catchaMouse16_Null_Model_Fit_Unweighted_Balanced_Accuracy.png",
...
```{r}
if (!file.exists(paste0(rdata_path, "ROI_wise_catchaMouse16_Unweighted_Null_Model_Fits_pvals.Rds"))) {
  region_wise_SVM_unweighted_pvals <- calc_empirical_nulls(class_res = region_wise_SVM_unweighted,
                                                          ...
                                                          grouping_var = "Brain_Region")
  saveRDS(region_wise_SVM_unweighted_pvals, file=paste0(rdata_path, "ROI_wise_catchaMouse16_Unweighted_Null_Model_Fits_pvals.Rds"))
} else {
  region_wise_SVM_unweighted_pvals <- readRDS(paste0(rdata_path, "ROI_wise_catchaMouse16_Unweighted_Null_Model_Fits_pvals.Rds"))
}
...
# Save plots
ggsave("plots/Region_Wise_catchaMouse16_Unweighted_Null_Model_Fits_Top_Regions_Out_of_Sample_SVM_Balanced_Accuracy.png", width=10, 
       height=5, units="in", dpi=300)
```
...
if (!file.exists(paste0(rdata_path, "ROI_wise_model_permutation_null_inv_prob_catchaMouse16.Rds"))) {
  ...
  saveRDS(model_permutation_null_inv_prob, file=paste0(rdata_path, "ROI_wise_model_permutation_null_inv_prob_catchaMouse16.Rds"))
} else {
  model_permutation_null_inv_prob <- readRDS(paste0(rdata_path, "ROI_wise_model_permutation_null_inv_prob_catchaMouse16.Rds"))
}
# Find number of iterations for plot label
...
```{r, fig.width=8, fig.height=5}
# Plot null accuracy and balanced accuracy compared with real metrics:
region_wise_SVM_in_sample_inv_prob <- readRDS(paste0(rdata_path, "ROI_wise_linear_SVM_CV_catchaMouse16_inv_prob.Rds"))

plot_main_vs_null_hist(main_res = region_wise_SVM_in_sample_inv_prob,
                       null_res = model_permutation_null_inv_prob,
                       xlab = sprintf("Value from n=%s Null Model Fit Shuffles", num_null_dist_values),
                       title = "Region-wise catchaMouse16 Inv Prob Linear SVM\nResults vs. Null Model Fits")

ggsave("plots/Region_Wise_catchaMouse16_Null_Model_Fit_Inv_Prob_Balanced_Accuracy.png",
       width=8, height=5, units="in", dpi=300)
```
...
# Save plot
ggsave("plots/Region_Wise_catchaMouse16_Inv_Prob_Null_Model_Fits_Top_Regions_Out_of_Sample_SVM_Balanced_Accuracy.png", width=10, 
       height=5, units="in", dpi=300)
```
...
if (!file.exists(paste0(rdata_path, "ROI_wise_model_permutation_null_SMOTE_catchaMouse16.Rds"))) {
  ...
  saveRDS(model_permutation_null_SMOTE, file=paste0(rdata_path, "ROI_wise_model_permutation_null_SMOTE_catchaMouse16.Rds"))
} else {
  model_permutation_null_SMOTE <- readRDS(paste0(rdata_path, "ROI_wise_model_permutation_null_SMOTE_catchaMouse16.Rds"))
}
# Find number of iterations for plot label
...
plot_main_vs_null_hist(main_res = region_wise_SVM_CV_SMOTE,
                       ...
                       xlab = sprintf("Value from n=%s Null Model Fit Shuffles", num_null_dist_values),
                       title = "Region-wise catchaMouse16 SMOTE Linear SVM\nResults vs. Null Model Fits")

# Save plot
ggsave("plots/Region_Wise_catchaMouse16_Null_Model_Fit_SMOTE_Balanced_Accuracy.png",
       width=8, height=5, units="in", dpi=300)
```
...
if (!file.exists(paste0(rdata_path, "ROI_wise_SMOTE_Null_Model_Fits_pvals_catchaMouse16.Rds"))) {
  region_wise_SVM_SMOTE_pvals <- calc_empirical_nulls(class_res = region_wise_SVM_CV_SMOTE,
                                                              ...
                                                              grouping_var = "Brain_Region")
  saveRDS(region_wise_SVM_SMOTE_pvals, file=paste0(rdata_path, "ROI_wise_SMOTE_Null_Model_Fits_pvals_catchaMouse16.Rds"))
} else {
  region_wise_SVM_SMOTE_pvals <- readRDS(paste0(rdata_path, "ROI_wise_SMOTE_Null_Model_Fits_pvals_catchaMouse16.Rds"))
}
...
# Save plot
ggsave("plots/Region_Wise_catchaMouse16_SMOTE_Null_Model_Fits_Top_Regions_Out_of_Sample_SVM_Balanced_Accuracy.png", width=10, 
       height=5, units="in", dpi=300)
```
...
ggsave("plots/Null_Distributions_by_Model_Type_catchaMouse16.png",
