...
def run_univariate_SVM(univariate_feature_file,
    ...
    # Save results
    feather.write_feather(fold_assignments_res, pydata_path + f"{dataset_ID}_{comparison_to_control_group}_Univariate_{univariate_feature_set}_SVM_fold_assigments.feather", version=1)
    feather.write_feather(SVM_coefficients_res, pydata_path + f"{dataset_ID}_{comparison_to_control_group}_Univariate_{univariate_feature_set}_SVM_fold_SVM_coefficients.feather", version=1)
    feather.write_feather(balanced_accuracy_res, pydata_path + f"{dataset_ID}_{comparison_to_control_group}_Univariate_{univariate_feature_set}_SVM_balanced_accuracy.feather", version=1)
    feather.write_feather(CV_sample_predictions_res, pydata_path + f"{dataset_ID}_{comparison_to_control_group}_Univariate_{univariate_feature_set}_SVM_sample_predictions.feather", version=1)
...
def run_univariate_nulls(univariate_feature_file,
    ...
    # Save results
    feather.write_feather(null_balanced_accuracy_res, pydata_path + f"{dataset_ID}_{comparison_to_control_group}_Univariate_{univariate_feature_set}_SVM_null_balanced_accuracy.feather", version=1)
...
def run_pairwise_nulls(pairwise_feature_file,
                     SPI_directionality_file,
                       univariate_feature_set, 
                       pairwise_feature_set,
                       dataset_ID,
...
def run_combined_SVM(univariate_feature_file,
    ...
    # Save results
    feather.write_feather(fold_assignments_res, pydata_path + f"{dataset_ID}_{comparison_to_control_group}_Univariate_{univariate_feature_set}_Pairwise_{pairwise_feature_set}_SVM_fold_assigments.feather", version=1)
    feather.write_feather(SVM_coefficients_res, pydata_path + f"{dataset_ID}_{comparison_to_control_group}_Univariate_{univariate_feature_set}_Pairwise_{pairwise_feature_set}_SVM_fold_SVM_coefficients.feather", version=1)
    feather.write_feather(balanced_accuracy_res, pydata_path + f"{dataset_ID}_{comparison_to_control_group}_Univariate_{univariate_feature_set}_Pairwise_{pairwise_feature_set}_SVM_balanced_accuracy.feather", version=1)
    feather.write_feather(CV_sample_predictions_res, pydata_path + f"{dataset_ID}_{comparison_to_control_group}_Univariate_{univariate_feature_set}_Pairwise_{pairwise_feature_set}_SVM_sample_predictions.feather", version=1)
    
def run_combined_nulls(univariate_feature_file,
        pairwise_feature_file,
                     SPI_directionality_file,
                       univariate_feature_set, 
                       pairwise_feature_set,
    ...
    # Save results
    feather.write_feather(null_balanced_accuracy_res, pydata_path + f"{dataset_ID}_{comparison_to_control_group}_Univariate_{univariate_feature_set}_Pairwise_{pairwise_feature_set}_SVM_null_balanced_accuracy.feather", version=1)
