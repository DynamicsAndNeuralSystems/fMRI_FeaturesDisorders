...
for comparison_group in Schizophrenia Bipolar ADHD; do
    ...
    for kernel in linear rbf; do
        ...
        # -m ae -M $email -l select=1:ncpus=$num_jobs:mem=${job_memory}GB,walltime=${num_hours}:00:00 -q $cluster_queue \
