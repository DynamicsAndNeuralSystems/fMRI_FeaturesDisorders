...
for comparison_group in Schizophrenia Bipolar ADHD; do
    ...
    pairwise_feature_file_base=$data_path/processed_data/${dataset_ID}_${noise_label}_
    ...
    # num_hours=6
    # num_folds=10
    # qsub -v dataset_ID=$dataset_ID,data_path=$data_path,comparison_group=$comparison_group,univariate_feature_set=$univariate_feature_set,pairwise_feature_set=$pairwise_feature_set,pairwise_feature_file_base=$pairwise_feature_file_base,SPI_directionality_file=$SPI_directionality_file,sample_metadata_file=$sample_metadata_file,noise_proc=$noise_proc,scaling_type=$scaling_type,num_folds=$num_folds,num_jobs=$num_jobs,num_repeats=$num_repeats \
    ...
    # job_memory=180
    # num_hours=150
    # qsub -v dataset_ID=$dataset_ID,data_path=$data_path,comparison_group=$comparison_group,univariate_feature_set=$univariate_feature_set,univariate_feature_file=$univariate_feature_file,pairwise_feature_set=$pairwise_feature_set,pairwise_feature_file_base=$pairwise_feature_file_base,SPI_directionality_file=$SPI_directionality_file,sample_metadata_file=$sample_metadata_file,noise_proc=$noise_proc,scaling_type=$scaling_type,num_null_iters=$num_null_iter,num_jobs=$num_jobs,num_repeats=$num_repeats \
